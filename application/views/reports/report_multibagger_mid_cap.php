<?php
$report = json_decode(file_get_contents('https://www.stockguru.in/api/v1/research/reports?apikey=asdfghjk&password=1234&action=get-report&report-name=multibagger-stocks-nifty500'));
//echo $report;
            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content">
                    <div class="breadcrumb-inner">
                        <h2 class="breadcrumb__title">Multibagger Mid Cap.</h2>
                        <ul class="breadcrumb__list">
                            <li class="active__list-item"><a href="<?php echo base_url() ?>members">Members</a></li>
                            <li>Multibagger Mid Cap</li>
                        </ul>
                    </div><!-- end breadcrumb-inner -->
                    <div class="text-outline">Mid Cap</div>
