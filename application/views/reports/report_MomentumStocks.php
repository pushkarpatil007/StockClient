<?php
$report = json_decode(file_get_contents('https://www.stockguru.in/api/v1/research/reports?apikey=asdfghjk&password=1234&action=get-report&report-name=momentum-stocks'));
//echo $report;
            ...
            <div class="col-lg-12">
                <div class="breadcrumb-content">
                    <div class="breadcrumb-inner">
                        <h2 class="breadcrumb__title">Momentum Stocks.</h2>
                    ...
                    <div class="text-outline">Momentum</div>
