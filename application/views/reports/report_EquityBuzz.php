<?php
$report = json_decode(file_get_contents('https://www.stockguru.in/api/v1/research/reports?apikey=asdfghjk&password=1234&action=get-report&report-name=equity-buzz'));
//echo $report;
